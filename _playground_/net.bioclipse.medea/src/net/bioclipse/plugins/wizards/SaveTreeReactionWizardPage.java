...
public class SaveTreeReactionWizardPage extends WizardPage {
	...
	private List list;
	private boolean saveReaction = true;
	...
	private HashMap spectrumFormat2ExtensionMap = new HashMap();
	{
		...
		spectrumFormat2ExtensionMap.put(RXN, ".rxn");
	}
	 ...
	 * 
	 */
	public SaveTreeReactionWizardPage() {
		super("TreeWizardPage");
		setTitle("Predicted Reaction Tree");
		setDescription("This wizard saves the predicted reaction tree which happens in" +
...
//	}
	...
	/**
	 * 
	 * @return True, if the reaction must be save
	 */
