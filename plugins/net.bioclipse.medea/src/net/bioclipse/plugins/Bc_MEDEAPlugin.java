 ...
 * @author Miguel Rojas
 */
public class Bc_MEDEAPlugin extends BioclipsePlugin implements IBioclipsePlugin {

	public static final String OPEN_PERSP_FOR_RES = "Open Medea Perspective";
	/**The plug-in ID*/
	public final static String PLUGIN_ID="net.bioclipse.medea";
	
	/**The shared instance.*/
	private static Bc_MEDEAPlugin plugin;
...
//		New logger with com.tools.logging
	 ...
	 */
	public static Bc_MEDEAPlugin getDefault() {
		return plugin;
	}
...
//				TestPlugin.getDefault().getLog()); 
	...
	protected void initializeDefaultPreferences(IPreferenceStore store) {
		store.setDefault(OPEN_PERSP_FOR_RES, Bc_MEDEAPlugin.UNSET);
	}
	/*
	 * (non-Javadoc)
